...
//         forEach is terminal method
        ...
        System.out.println(ls2); // Stream ref does not affect the original data source
        ...
        // Optional is a Data type when the result can be empty
        ...
        /*
        reduce method - Take large number of values and reduce it to one value
        It accepts two params - initial value and implementation
         */
        ...
        // Find max value from list using streams
        ...
        /*
        List.Of() - creates a immutable, we cannot modify that
        So use ArrayList
         */
        ...
        // Sorting with proper comparison
